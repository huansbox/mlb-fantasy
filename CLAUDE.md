...
**Nola 結構性 cut 候選**（啟動 2026-04-20，04-22 找到合格 FA）
- 觸發：2026 Sum 11（xERA 4.67 P25-40 / xwOBA .342 P25-40 / HH% 42.1 P40-45）+ 2025 Sum 15（4.13 / .315 / 43.3%）雙年雙確認弱
- 判定：「當季低 + 前一年低 → 結構性確認」（CLAUDE.md 減分側矩陣）
- 運氣 -0.39 中性 + 32 歲累積傷病不會變好 + **速度 04 月 90.7 mph 完全等於 2025 災難年**（春訓 92.9 已消失）= 物理結構訊號
- 候選（04-22 fa_scan #98）：
  - **Max Meyer** (MIA, SP) 18% — 首選：Sum 18 vs 11 三項全勝，BBE 70 高信心、21d 持平、球隊主力、K/9 10.1 結構壓制
  - **Foster Griffin** (WSH, SP/RP) 10% — 備案：Sum 17 三項勝，運氣 +0.89 ERA 會回升
  - Brandon Pfaadt (AZ, SP) 0% — 等下次先發：Sum 21 最高但 21d xwOBA Δ+0.036 下滑剛觸發 + K/9 5.5 結構性弱（04-19 1ER 是 BABIP 運氣）
- 行動：試 1 個交易對象（24h 窗口）→ 無回應 → FAAB Meyer $3-5 / drop Nola
- 狀態：等執行（04-22 評估完成）
