...
**Nola 結構性 cut 候選**（啟動 2026-04-20 下午）
- 觸發：2026 Sum 17（xERA 4.10 P55 / xwOBA .323 P45 / HH% 39.7 P55）+ 2025 Sum 15（4.13 / .315 / 43.3%）雙年雙確認弱
- 判定：「當季低 + 前一年低 → 結構性確認」（CLAUDE.md 減分側矩陣）
- 運氣 +0.07 中性 = 帳面就是真實水準（無回升空間）+ 32 歲累積傷病不會變好
- 行動：等 FA 明確升級才動手
- 候選：Chad Patrick (MIL, Sum 24 / 2025 Sum 19 / BBE 59 / IP/GS 5.3 / 0% owned) — 邊緣但唯一真 SP + 強隊 + 高信心；運氣 +2.09 極端，ERA 會回升
- 狀態：觀察 FA 池，無匹配前 hold Nola
