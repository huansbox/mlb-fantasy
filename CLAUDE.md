...
> 設計依據：`docs/sp-framework-v4-balanced.md`。Production live = v4 + Phase 6 multi-agent（`fa_scan.py` default `SP_FRAMEWORK_VERSION=v4`）。v2（xERA / xwOBA / HH% 三指標）僅作 rollback fallback。
