...
| [`036-fa-sort-key-debias`](036-fa-sort-key-debias.md) | AFK | 無 | ✅ 2026-06-10（雲端 session 完工，PR #308；隔日 cron 後驗證 FA 順序 = %owned 降序） |
